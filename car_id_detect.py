...
def CaridDetect(car_pic):
    ...
    cv2.imwrite(os.path.join("./temp/0COLOR_BGR2GRAY.jpg"), img)
    ...
    cv2.imwrite(os.path.join("./temp/1img_opening.jpg"), img_opening)
    ...
    cv2.imwrite(os.path.join("./temp/2img_edge.jpg"), img_edge)
    ...
    cv2.imwrite(os.path.join("./temp/3img_edge2.jpg"), img_edge2)
    ...
    for card_index, card_img in enumerate(card_imgs):
        ...
        limit1 = limit2 = 0
        # print(yello,green,blue,black,white,card_img_count)
        ...
        xl, xr, yh, yl = accurate_place(
            card_img_hsv, limit1, limit2, color, cfg)
        if yl == yh and xl == xr:
            continue
        need_accurate = False
        if yl >= yh:
